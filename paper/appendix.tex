...
\section{Robustness to Control Group Construction}
\label{sec:app-robustness}

Our results may be sensitive to how the control group is defined. In this section, we examine robustness along several dimensions: the required lag in state-level CAH adoption, the post-period event window length, the exclusion of immediate adopters, the exclusion of never-treated states, and the bed size cutoff used to define sample eligibility.
...
\caption[State-Level Lag Sensitivity]{\textbf{Robustness of SDID estimates to varying state-level CAH adoption lags ($\delta$)}\footnote{Each panel displays one outcome. The shaded band spans the baseline ($\delta = 0$) 95\% confidence interval; the dashed line marks the baseline point estimate. Points show SDID ATTs at $\delta = 1$ and $\delta = 2$, with 95\% confidence intervals. Circles and squares denote $\delta = 1$ and $\delta = 2$, respectively. For hospital-level outcomes, cohort-lag combinations with fewer than 5 control hospitals in the balanced panel are excluded from estimation; missing points indicate that no cohort met this threshold at the given lag.}}
...
\centering
\begin{minipage}[h]{6in}
\caption[Post-Period Sensitivity]{\textbf{Robustness of SDID estimates to varying post-period event window lengths}\footnote{Each panel displays one outcome. The shaded band spans the baseline (5-year post-period) 95\% confidence interval; the dashed line marks the baseline point estimate. Points show SDID ATTs at post-period lengths of 5, 4, 3, and 2 years, with 95\% confidence intervals.}}
...
\centering
\begin{minipage}[h]{6in}
\caption[Excluding Immediate Adopters]{\textbf{Robustness of SDID estimates to excluding immediate adopters}\footnote{Each panel displays one outcome. The shaded band spans the baseline 95\% confidence interval; the dashed line marks the baseline point estimate. Points show SDID ATTs after dropping hospitals that converted to CAH in the same year their state first implemented the program (121 of 1,466 treated hospitals).}}
...
\centering
\begin{minipage}[h]{6in}
\caption[Excluding Never-Treated States]{\textbf{Robustness of SDID estimates to excluding never-treated states}\footnote{Each panel displays one outcome. The shaded band spans the baseline 95\% confidence interval; the dashed line marks the baseline point estimate. Points show SDID ATTs after dropping all hospitals in states that never adopted CAH designation (Connecticut, New Jersey, and Rhode Island; 10 hospitals with $\leq 50$ beds).}}
...
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{Pre/post trends: Financial performance outcomes}}
\label{fig:pretrend-financial}
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-margin.png} &
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-current_ratio.png} \\[0.5cm]
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-net_fixed.png} &
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-capex.png} \\[0.5cm]
...
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{Pre/post trends: Capacity and staffing outcomes}}
\label{fig:pretrend-capacity}
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-bdtot.png} &
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-obbd.png} \\[0.5cm]
...
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{Pre/post trends: Organizational change outcomes}}
\label{fig:pretrend-org}
\begin{tabular}{cc}
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-system.png} &
\includegraphics[width=0.48\textwidth]{../results/diagnostics/diag-pretrend-closures.png} \\[0.5cm]
...
This section presents Callaway and Sant'Anna (CS) event-study estimates for all outcomes, complementing the SDID estimates in the main text. The CS estimator accommodates unbalanced panels and traces dynamic treatment effects over event time, a useful complement to SDID when balanced-panel requirements induce sample attrition. We also report ATT estimates from the eligibility-restricted control group design described in the main text.

Table~\ref{tab:cs-overall} reports CS ATT estimates for all outcomes under the state-timing control group construction used in the main text, using the ``not-yet-treated'' control group specification and aggregating across cohorts via the CS group-time ATT framework.
...
Figures~\ref{fig:cs-financial}--\ref{fig:cs-org} present the corresponding CS event-study estimates, plotting dynamic treatment effects over event time relative to CAH designation.

\begin{figure}[!h]
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{CS event-study estimates: Financial performance and capital outcomes}}
...
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{CS event-study estimates: Capacity and staffing outcomes}}
...
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{CS event-study estimates: Organizational change outcomes}}
\label{fig:cs-org}
\begin{tabular}{cc}
...
Figures~\ref{fig:elig-cs-financial}--\ref{fig:elig-cs-capacity} present the CS event-study estimates from the eligibility-restricted design.

\begin{figure}[!h]
\centering
\begin{minipage}[h]{6in}
\caption{\textbf{CS event-study estimates (eligibility-restricted): Financial performance and capital outcomes}}
