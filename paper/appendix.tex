...
This section presents two sets of supplementary results. First, we report Callaway--Sant'Anna (CS) event-study estimates for all outcomes, complementing the SDID estimates in the main text. The CS estimator accommodates unbalanced panels and traces dynamic treatment effects over event time, making it a useful complement to SDID in settings where balanced-panel requirements induce substantial sample attrition. Second, we report overall ATT estimates from the eligibility-restricted control group design described in Section~4.6 of the main text.
